...
//        }
//    }
    private static boolean shouldWakeUp(boolean barking, int hourDay){
        return barking && ((hourDay < 8 && hourDay >= 0) || (hourDay == 23));
    }
}
