package hari14.leapyearcalculator;
...
NOTE: Do not add a  main method to solution code.
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        // anotherIsLeapYear
        result = anotherIsLeapYear(-1600);
        System.out.println(result);
        result = anotherIsLeapYear(1600);
        System.out.println(result);
        System.out.println();

        result = anotherLeapYear(-1600);
        System.out.println(result);
        result = anotherLeapYear(1600);
        System.out.println(result);
        result = anotherLeapYear(2017);
        System.out.println(result);
        result = anotherLeapYear(2000);
        System.out.println(result);
    ...
    private static boolean anotherIsLeapYear(int year) {
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.YEAR, year);
        return calendar.getActualMaximum(Calendar.DAY_OF_YEAR) > 365;
    }

    private static boolean anotherLeapYear(int year) {
        if (year >= 1 && year <= 9999) {
